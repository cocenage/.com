<div
    ...
    <div class="py-[80px] px-[48px] flex flex-col gap-[8px] relative z-20">
        <h1>Про меня</h1>
        <!-- <p class="text-[14px] text-gray-500">Мне похуй</p> -->
    </div>
        ...
        <template x-for="(slide, i) in slides" :key="i">
            <div
                ...
                <img
                    :src="slide.image"
                    :alt="slide.title"
                    class="max-w-[min(80vw,1100px)] w-[70%] h-auto object-contain will-change-transform pointer-events-none select-none">
            </div>
        </template>
    </div>
